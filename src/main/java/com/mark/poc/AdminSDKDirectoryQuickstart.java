...
/**
 * For this usecase, you will need to use oauth authentication method.
 */
public class AdminSDKDirectoryQuickstart {
    ...
    private static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT) throws IOException {
        ...
        //System.out.println("web client_id: " + clientSecrets.getWeb().getClientId());
        System.out.println("installed client_id: " + clientSecrets.getInstalled().getClientId());
